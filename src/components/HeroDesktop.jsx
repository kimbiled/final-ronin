...
const HeroDesktop = () => {
    ...
    <button 
        className="bg-[#1261FC] text-white rounded-lg w-[176px] h-12 transition-all duration-200 
    ...
    <button 
        className="bg-transparent border border-[#1261FC] text-[#1261FC] rounded-lg w-[184px] h-12 transition-all duration-200 
